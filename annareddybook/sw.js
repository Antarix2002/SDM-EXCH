(() => {
    ...
    s.n = e => {
        ...
        var e = s(89),
            ...
            r = s(522),
            i = s(634);
        const c = JSON.parse('["annareddybook\\\\.com(?:/.*)?/ola/services/.*","annareddybook\\\\.com/ola/meetings/.*","/api/","https://api\\\\.ola\\\\.godaddy\\\\.com","https://15548580-a893-4a37-b603-446968d99d24\\\\.onlinestore\\\\.godaddy\\\\.com","/t/1/tl/event","google-analytics\\\\.com/collect","calendar\\\\.apps\\\\.(dev-|test-)?secureserver\\\\.net"]').map((e => new RegExp(e))),
            o = JSON.parse('["annareddybook\\\\.com(?:/.*)?/f/.*","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/15548580-a893-4a37-b603-446968d99d24/feed/post/","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/15548580-a893-4a37-b603-446968d99d24/feed"]').map((e => new RegExp(e))),
            h = JSON.parse('["/landing-page","/"]').map((e => ({
                url: e,
                revision: "1767942255648"
            })));
        self.addEventListener("activate", (function(e) {
            e.waitUntil(caches.keys().then((function(e) {
                return Promise.all(e.filter((e => e.startsWith("annareddybook.com-"))).map((e => caches.delete(e))))
            })))
